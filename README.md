...
Modern project robot usernames usually include the project name. In `demo.goharbor.io`, the current convention is `robot_si_demo_harbor+cluster-pull`. Copy the exact username Harbor shows; do not shorten it.
